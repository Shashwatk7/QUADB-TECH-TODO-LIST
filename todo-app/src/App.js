...
//               <input type="text" value={newDescription} onChange={(e)=>setNewDescription(e.target.value)} placeholder="Description about your task"/>
//             </div>
//             <div className="todo-input-item">
//               <button type='button' onClick={handleAddTodo} className='primaryBtn'>Click to Add</button>
//             </div>
//           </div>

//           <div className='btn-area'>
//             <button className={`isComplete ${isComplete===false && 'active'}`} onClick={()=>setisComplete(false)}>Todo</button>
